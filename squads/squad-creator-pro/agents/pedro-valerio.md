...
- `*create-from-sop --business={slug}` - Criar artefatos a partir de SOPs YAML canonicos do workspace
...
commands:
  ...
  - name: "*create-agent {name}"
    ...
    visibility: [full, quick]
  - name: "*create-from-sop --business={slug}"
    description: "Carregar SOPs YAML do workspace/business e derivar artefatos"
    visibility: [full, quick, key]
  - name: "*audit"
...
| `*create-from-sop` | `tasks/create-from-sop.md` | — |
