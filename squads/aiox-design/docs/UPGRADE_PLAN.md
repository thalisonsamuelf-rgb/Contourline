...
|---------|--------|----------|-----|
| **Tier System** | ✅ DONE | `squads/aiox-design/config.yaml` | — |
| **Foundations** | ✅ DONE | `squads/aiox-design/data/design-tokens-spec.yaml` | — |
| **Prompt Injection** | ✅ DONE | `squads/aiox-design/templates/component-prompt-injection-tmpl.md` | — |
...
**Validação:** `squads/aiox-design/scripts/design-system/test_mcp_tools.cjs` — 8/8 tools PASS.
...
**Validação:** `squads/aiox-design/scripts/design-system/validate_registry.cjs` — schema check, type enums, dependency resolution.
