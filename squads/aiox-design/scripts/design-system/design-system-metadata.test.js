...
describe('design system metadata pipeline', () => {
  test('generates metadata/components.json', () => {
    const result = spawnSync('node', ['squads/aiox-design/scripts/design-system/generate_components_metadata.cjs'], {
      encoding: 'utf8'
    });
  ...
  test('validates metadata/components.json', () => {
    const result = spawnSync('node', ['squads/aiox-design/scripts/design-system/validate_components_metadata.cjs'], {
      encoding: 'utf8'
    });
  ...
  test('validates MCP skeleton', () => {
    const result = spawnSync('node', ['squads/aiox-design/scripts/design-system/validate_mcp_skeleton.cjs'], {
      encoding: 'utf8'
    });
  ...
  test('syncs design manifest from squad.yaml', () => {
    const result = spawnSync('node', ['squads/aiox-design/scripts/design-system/sync_design_manifest.cjs'], {
      encoding: 'utf8'
    });
  ...
  test('validates design manifest drift', () => {
    const result = spawnSync('node', ['squads/aiox-design/scripts/design-system/validate_design_manifest_drift.cjs'], {
      encoding: 'utf8'
    });
