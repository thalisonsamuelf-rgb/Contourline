...
4. Registrar se a integração é `consulting-only`, isto é, só válida quando `squads/c-level/` está presente.
...
2. Se `squads/c-level/` não existe, nenhum squad novo pode ser promovido para esses dois níveis.
...
- `squads/c-level/checklists/squad-workspace-fit-checklist.md`
