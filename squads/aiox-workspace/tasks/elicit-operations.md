...
*Gerado via Squad AIOX Workspace (COO) em {date}*
```

## Próximo Passo: SOP Documentation

Após completar a elicitação operacional, considere documentar processos via AIOX-SOP:
...
Isso transforma os YAMLs de operations (team-structure, pricing-strategy, kpi-scorecards, commission-design) em SOPs executáveis por humanos e agentes IA. Os SOPs são salvos em `workspace/businesses/{slug}/sops/`.
...
- [ ] Arquivo salvo em `workspace/config.yaml`
