...
### Step 4.4: Validate Workflow Contract (Mandatory)

**CRITICAL:** Every workflow created MUST pass `workflow-validator.js` in strict mode before handoff.
...
phase_4_output:
  ...
  workflow_contract_validation: "PASS"
  lines: 650
  status: "PASS"
```
...
- [ ] `workflow-validator.js` PASS em `--strict --fail-on-warnings` para o arquivo criado
