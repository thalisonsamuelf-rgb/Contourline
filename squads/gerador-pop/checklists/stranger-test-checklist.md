...
> **Purpose:** Verify that an SOP can be executed correctly by a qualified person with ZERO tribal knowledge. This is the ultimate executability test, applied by @pop-criador before declaring an SOP complete.
>
