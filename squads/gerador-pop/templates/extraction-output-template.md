...
>
> Produced by @pop-extrator after process extraction. This is the handoff artifact
> consumed by @pop-criador (human SOP) or @pop-ml-arquiteto (ML SOP).
...
**Handoff To:** {{@pop-criador / @pop-ml-arquiteto / Both}}
