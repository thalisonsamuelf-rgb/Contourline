...
FILE: outputs/gerador-pop/checklists/{process-name}-{type}-checklist-v{version}.md
```
...
outputs:
  primary:
    path: "outputs/gerador-pop/checklists/{process-name}-{type}-checklist-v{version}.md"
    format: markdown
