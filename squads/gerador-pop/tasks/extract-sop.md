...
| **Version** | `1.0.0` |
| **Status** | `active` |
| **Responsible Executor** | `pop-extrator` |
...
outputs:
  primary:
    path: "outputs/gerador-pop/extractions/{process-name}-draft-sop-v{version}.md"
    format: markdown
    description: "Draft SOP with confidence annotations, gaps, and teach-back instructions"

  secondary:
    - path: "outputs/gerador-pop/extractions/{process-name}-gaps.md"
      format: markdown
      description: "Detailed gap report with suggested resolutions"

    - path: "outputs/gerador-pop/extractions/{process-name}-confidence-map.md"
      format: markdown
