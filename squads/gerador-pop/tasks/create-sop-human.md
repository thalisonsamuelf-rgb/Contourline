...
| **Version** | `1.0.0` |
| **Status** | `active` |
| **Responsible Executor** | `pop-criador` |
...
FILE: outputs/gerador-pop/human/{process-name}-sop-v{version}.md
...
outputs:
  primary:
    path: "outputs/gerador-pop/human/{process-name}-sop-v{version}.md"
    format: markdown
    description: "Complete human-readable SOP with all 11 FDA/GMP sections"

  secondary:
    - path: "outputs/gerador-pop/human/{process-name}-summary.md"
      format: markdown
