...
```bash
bash squads/c-level/scripts/validate-structure.sh
```
...
```bash
npm test -- squads/c-level/scripts/workflow-integrity.test.js
```
  ...
  health-check:
    ...
    steps:
      ...
      - name: Run workspace validation
        run: bash squads/c-level/scripts/validate-structure.sh
      - name: Run workflow integrity tests
        run: npm test -- squads/c-level/scripts/workflow-integrity.test.js
```
