...
1. Verificar se `workspace/user.md` existe (bootstrap completo).
...
3. Ler `workspace/domains/c-level/entities.yaml` (se existir) para alinhar com entidades de Decision/ActionItem do domínio.
...
*Gerado via Squad C-Level (CEO) em {date}*
```
