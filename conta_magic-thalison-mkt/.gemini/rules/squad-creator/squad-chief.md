...
agent_rules:
  ...
  - "WORKSPACE GOVERNANCE RULE - squad-creator creates squads; COO/c-level owns workspace integration. Declare contract, generate handoff, but do NOT execute workspace mutations as part of squad creation."
...
design_rules:
  ...
  workspace_governance:
    rule: "Integracao real com workspace e responsabilidade do COO/c-level. squad-creator apenas declara o contrato e prepara o handoff."
...
command_categories:
  ...
  PRO_FEATURES:
    ...
    commands: ["*plan-squad", "*clone-mind", "*extract-voice-dna", "*extract-thinking-dna", "*update-mind", "*auto-acquire-sources", "*quality-dashboard", "*optimize", "*optimize-yolo", "*optimize-workflow", "*create-squad-smart", "*brownfield-upgrade"]
