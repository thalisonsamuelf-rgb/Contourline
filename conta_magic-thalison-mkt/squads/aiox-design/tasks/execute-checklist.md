...
If the user asks or does not specify a specific checklist, list the checklists available in `squads/aiox-design/checklists/`.

## Local Checklist Catalog (`squads/aiox-design/checklists/`)
...
1. **Initial Assessment**
   ...
   - If user or the task being run provides a checklist name:
     ...
     - Load the appropriate checklist from `squads/aiox-design/checklists/`
   - If no checklist specified:
     - Ask the user which checklist they want to use
     - Present the available options from `squads/aiox-design/checklists/`
