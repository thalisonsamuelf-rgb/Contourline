...
4. `aiox-sop` e `squad-creator-pro` usam contexto `operations`.
5. O registry canônico de squads, contexts e product consumers vive em `squads/aiox-workspace/config.yaml`.
