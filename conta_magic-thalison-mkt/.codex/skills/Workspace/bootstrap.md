...
Primeira task obrigatória do Squad AIOX Workspace. Cria o arquivo `workspace/user.yaml` com informações básicas do usuário e estrutura inicial do workspace.
...
2. Criar subdiretórios:
   ...
   - `workspace/design/styles/`
3. Criar `workspace/user.yaml` com as informações coletadas
4. Criar `workspace/config.yaml` com configuração inicial
...
---
*Configuração gerenciada pelo COO - Squad AIOX Workspace*
```
...
- [ ] Diretório `workspace/design/` existe com subdiretórios
