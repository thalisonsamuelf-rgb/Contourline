...
export function PythonIcon({ className, size = 24 }: PythonIconProps) {
  return (
    <svg
    ...
    >
      <defs>
        <linearGradient id="python-a" x1="12.959%" y1="12.039%" x2="79.639%" y2="78.201%">
          <stop offset="0%" stopColor="#387EB8" />
          <stop offset="100%" stopColor="#366994" />
        </linearGradient>
        <linearGradient id="python-b" x1="19.128%" y1="20.579%" x2="90.742%" y2="88.429%">
