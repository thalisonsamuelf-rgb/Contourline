...
outputs:
  ...
  certificate_artifact:
    ...
    pattern: "outputs/gerador-pop/certificates/{sop-id}-certificate-{YYYYMMDD}.md"

  certification_report:
    type: filepath
    pattern: "outputs/gerador-pop/certificates/{sop-id}-certification-report-{YYYYMMDD}.md"
```
