...
| **Version** | `1.0.0` |
| **Status** | `active` |
| **Responsible Executor** | `pop-auditor` |
...
FILE: outputs/gerador-pop/audits/batch-audit-dashboard-{date}.md

IF output_format == "detailed":
  ALSO generate individual audit reports per SOP in:
  outputs/gerador-pop/audits/individual/{sop-name}-quick-audit.md
```
...
outputs:
  primary:
    path: "outputs/gerador-pop/audits/batch-audit-dashboard-{date}.md"
    format: markdown
    description: "Batch audit dashboard with organizational health score, heatmap, rankings, patterns, and recommendations"

  secondary:
    - path: "outputs/gerador-pop/audits/individual/{sop-name}-quick-audit.md"
      format: markdown
