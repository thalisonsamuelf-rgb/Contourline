...
> **Purpose:** Verify that a process extraction by @pop-extrator captured all required sections before handoff to @pop-criador or @pop-ml-arquiteto. This is the quality gate between EXTRACTION and CREATION stages.
>
...
**Handoff Decision:**
- [ ] **READY** — Proceed to @pop-criador or @pop-ml-arquiteto
